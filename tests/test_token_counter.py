"""Tests for bughunter.agent.token_counter — estimation + sliding-window truncation."""

from bughunter.agent.token_counter import (
...
class TestTruncateMessages:
    ...
    def test_inserts_truncation_notice(self):
        ...
        notices = [m for m in result if "Context Truncation" in str(m.get("content", ""))]
