"""BugHunter CLI module tests for main.py."""
...
class TestCLI:
    ...
    def test_cli_help(self, runner):
        ...
        assert "BugHunter" in result.output or "bughunter" in result.output.lower()
    ...
    def test_cli_init(self, runner):
        ...
        # Should not crash
        assert result.exit_code == 0
        assert "bughunter" in result.output
    ...
    def test_cli_kb_update(self, runner, monkeypatch, tmp_path):
        import bughunter.kb.store as kb_store
        from bughunter.cli.main import app
    ...
    def test_repl_persistent_explicit_target_restores_history(self, runner, monkeypatch):
        import bughunter.agent.core as agent_core
        import bughunter.cli.main as cli_main
    ...
    def test_report_target_mode(self, runner, monkeypatch, tmp_path):
        ...
        assert result.exit_code == 0
        assert "Report generated" in result.output or "Report has been generated" in result.output or "Report has been generated" in result.output or result.output
    ...
    def test_repl_report_command_uses_current_session_or_target_state(self, runner, monkeypatch):
        ...
        assert result.exit_code == 0
        assert "Report generated" in result.output or "Report has been generated" in result.output
    ...
    def test_repl_persistent_interrupt_generates_final_report(self, runner, monkeypatch):
        ...
        assert result.exit_code == 0
        assert "Final report" in result.output or "Final report" in result.output
    ...
    def test_tui_once_renders_target_overview(self, runner, monkeypatch):
        import bughunter.cli.tui as tui_mod
        from bughunter.cli.main import app
    ...
    def test_tui_dry_run_renders_launch_summary(self, runner):
        ...
        assert "bughunter scan https://example.com" in result.output
    ...
    def test_tui_runtime_diagnostic_panel_renders_environment_summary(self, monkeypatch):
        ...
        import bughunter.web.services.mcp_service as mcp_service
...
class TestCLISubCommands:
    ...
    def test_run_with_prompt_option(self, runner):
        # [Modify] 2026-06-10 Nyaecho - Add --prompt Option testing
        from bughunter.cli.main import app
