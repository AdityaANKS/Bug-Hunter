      ...
      <div className="goby-home-board">
        ...
        <div className="scan-launch goby-task-panel">
          <div className="goby-task-title">
            ...
            <span className="sandbox-indicator sandbox-online" title={t("home.sandbox_ready")}>⬤ {t("home.sandbox_ready")}</span>
            <button type="button" className="text-btn inline-text-btn" onClick={() => { setTarget(""); setUserPrompt(""); }} aria-label={t("home.clear_target")}>
              ×
            </button>
          </div>
          ...
          <div className="goby-task-form">
            ...
            <label className="field scan-prompt-field field-wide">
              ...
              <div className="tool-chip-row">
                <button type="button" className="tool-chip" onClick={() => appendToPrompt("subdomain enumeration, DNS recon, WHOIS lookup")}>{t("home.chip_recon")}</button>
                <button type="button" className="tool-chip" onClick={() => appendToPrompt("web vulnerability scanning with nikto and nuclei")}>{t("home.chip_web")}</button>
                <button type="button" className="tool-chip" onClick={() => appendToPrompt("SQL injection testing with sqlmap")}>{t("home.chip_exploit")}</button>
                <button type="button" className="tool-chip" onClick={() => appendToPrompt("port scanning, service detection, network mapping")}>{t("home.chip_network")}</button>
                <button type="button" className="tool-chip" onClick={() => appendToPrompt("brute force login with hydra")}>{t("home.chip_bruteforce")}</button>
                <button type="button" className="tool-chip" onClick={() => appendToPrompt("directory fuzzing with ffuf and gobuster")}>{t("home.chip_fuzzing")}</button>
              </div>
            </label>
