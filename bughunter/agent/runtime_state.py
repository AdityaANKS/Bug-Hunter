"""Bug Hunter Agent Runtime State — per-run mutable state containers."""
...
try:
    from bughunter.agent.reflexion import ReflexionEngine
except ImportError:
...
class RuntimeState:
    ...
    # Time-budgeted scan tracker (set by loop_controller when budget is active)
    scan_budget: Any = None
