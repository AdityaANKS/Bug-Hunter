"""Internationalization support for Bug Hunter."""
...
class I18nLoader:
    ...
    def detect_language() -> str:
        ...
        Priority:
        1. BUGHUNTER_LANG environment variable
        2. LANG environment variable
        3. Default to 'en'
        """
        # Check Bug Hunter specific env var
        lang_env = os.environ.get("BUGHUNTER_LANG", os.environ.get("BUGHUNTER_LANG", "")).lower()
...
def init_i18n(lang: Optional[str] = None, config: Any = None) -> I18nLoader:
    ...
    Args:
        ...
        config: Bug Hunter config object with session.language setting
    """
    global _translator
    if lang is None:
        # Try config first
