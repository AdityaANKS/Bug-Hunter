...
from bughunter.plugins.base import PluginContext, VulnPlugin
from bughunter.plugins.registry import PluginRegistry, registry
from bughunter.plugins.result import PluginResult, PluginStage
...
class PluginRuntime:
    ...
    async def execute(
        ...
        try:
            ...
            # Python 3.10 Down asyncio.wait_for throw asyncio.TimeoutError(With the built-in TimeoutError
            # Not the same category,3.11 Merged only after starting), both are captured to ensure cross-Versionconsistent
