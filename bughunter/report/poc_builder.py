"""Bug Hunter PoC Builder — auto-generate runnable PoC scripts for findings."""
...
from bughunter.report.verifier import PoCGenerator
...
Target: {{ target }}
Generated by Bug Hunter on {{ generated_at }}
