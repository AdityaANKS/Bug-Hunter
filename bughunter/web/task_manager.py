...
from bughunter.config.settings import WEB_TASKS_FILE, ensure_dirs
from bughunter.web.schemas import TaskCreateRequest, TaskEvent, TaskRecord, TaskSummary
    ...
    async def stream_events(self, task_id: str):
        ...
        while True:
            ...
            try:
                ...
                # In Python 3.10 asyncio.wait_for raises asyncio.TimeoutError (merged with
                # built-in TimeoutError starting from 3.11). Catch both to keep streaming
                # loop working across Python versions.
                continue
