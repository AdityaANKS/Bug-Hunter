...
from bughunter.config.settings import apply_provider_preset, load_config, save_config
from bughunter.web.schemas import ConfigUpdateRequest, ConfigView, ModelPoolEntryView
...
def get_public_config() -> ConfigView:
    ...
    return ConfigView(
        ...
        model_pool=[
            ...
            for entry in config.llm.model_pool
        ],
    )
