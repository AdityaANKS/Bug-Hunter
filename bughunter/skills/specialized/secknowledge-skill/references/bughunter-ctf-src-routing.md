# BugHunter CTF/SRC Routing Guide

This reference connects `secknowledge-skill` to BugHunter's CTF and SRC workflows.
...
Keep BugHunter's existing specialist skills in the loop:
...
2. If it is a narrow CTF trick, route to the matching BugHunter CTF skill and use this skill only for broader vulnerability families or evidence discipline.
