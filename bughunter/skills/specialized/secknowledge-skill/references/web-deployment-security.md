...
> **Relevant**: AIApplication container escape testing → [ai-baseline-escape.md](ai-baseline-escape.md)
...
> **AIApplication container escape**: TargetingAI Agent/LLMContainer escape testing methodology for deployment environments → [ai-baseline-escape.md](ai-baseline-escape.md)
