...
- Cache andCDNSecurity: `references/web-playbook-03-cache-and-cdn-security.md`
...
- Prototype chain pollution: `references/web-playbook-10-prototype-pollution.md`
...
- SQL/NoSQLInjection: `references/web-playbook-18-sql-nosql-injection.md`
...
- XSSCross-site scripting: `references/web-playbook-22-xss-cross-site-scripting.md`
- XXEEntity injection: `references/web-playbook-23-xxe-entity-injection.md`
