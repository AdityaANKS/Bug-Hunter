...
|------|----------|-------------|----------------|
| LLM01 | Prompt Injection | AIApplication testing → PromptInjection | ai-app-security.md |
| LLM02 | Sensitive Information Disclosure | AIData testing → Data leakage | ai-data-security.md |
| LLM03 | Supply Chain Vulnerabilities | AIbase testing → Supply chain | ai-baseline-security.md |
| LLM04 | Data and Model Poisoning | AIData testing → Data poisoning | ai-data-security.md |
| LLM05 | Improper Output Handling | AIApplication testing → Insecure output | ai-app-security.md |
| LLM06 | Excessive Agency | AIIdentity Test → Permission control | ai-identity-security.md |
| LLM07 | System Prompt Leakage | AIData testing → PromptDisclosure | ai-data-security.md |
| LLM08 | Vector and Embedding Weaknesses | AIbase testing → VectorDB | ai-baseline-security.md |
| LLM09 | Misinformation | AIModel testing → Hallucination/False Information | ai-model-security.md |
| LLM10 | Unbounded Consumption | AIbase testing → Denial of service | ai-baseline-security.md |
...
| Number | Risk name | This methodology corresponds to | Reference File |
|------|----------|-------------|----------------|
| ASI01 | Agent Goal Hijack | Through direct/Indirect Instruction Injection ManipulationAgentObjective | ai-app-security.md |
| ASI02 | Tool Misuse & Exploitation | AgentDynamically call tools(API/DB/Service)Attack surface | ai-app-security.md |
| ASI03 | Agent Identity & Privilege Abuse | AgentMisuse of identity and permission credentials | ai-identity-security.md |
| ASI04 | Agentic Supply Chain Compromise | AgentDependencies and third-party component supply chain vulnerabilities | ai-baseline-security.md |
| ASI05 | Unexpected Code Execution | AgentUnexpected code execution due to reasoning and tool calls | ai-app-security.md, ai-baseline-security.md |
| ASI06 | Memory & Context Poisoning | Long-term poisoning and state corruption of persistent context | ai-app-security.md |
| ASI07 | Insecure Inter-Agent Communication | MultipleAgentManipulation of inter-system communication and trust exploitation | ai-identity-security.md |
| ASI08 | Cascading Agent Failures | Single point vulnerability through tools/Memory/AgentChain propagation | ai-model-security.md |
| ASI09 | Human-Agent Trust Exploitation | User overtrustAgentOutput | ai-data-security.md |
| ASI10 | Rogue Agents | AgentInfiltrated or operating beyond authorized parameters | ai-identity-security.md |
...
|-----------|--------|-------------|----------------|
| WSTG-INPV | Input validation testing | SQLInjection/XSS/Command execution | web-injection.md |
...
| WSTG-CLNT | Client testing | DOM XSS/Front-end security | web-injection.md |
| WSTG-CONF | Configuration Management Test | Information leakage./Default Configuration/Misconfiguration | web-file-infra.md + web-deployment-security.md |
| WSTG-CRYP | Cryptographic testing | Weak encryption/Certificate/Transmission security | web-deployment-security.md |
| WSTG-ERRH | Error Handling Testing | Error message leakage/Stack trace | web-file-infra.md |
